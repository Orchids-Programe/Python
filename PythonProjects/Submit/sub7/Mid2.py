class ComplexNumber:
    ...
    def addComplex(self, frac):
        ...
        '''
        a = ComplexNumber(1, 1)
        a.real = self.real + frac.real
        a.image = self.image + frac.image
        return a
        # pass
    ...
    def multiComplex(self, frac):
        ...
        '''
        a = ComplexNumber(1, 1)
        a.real = self.real * frac.real - self.image * frac.image
        a.image = self.real * frac.image + self.image * frac.real
        return a
        # pass
    ...
    def divComplex(self, frac):
        ...
        '''
        a = ComplexNumber(1, 1)
        z = ComplexNumber(frac.real, -frac.image)
        denominator = (z.real) ** 2 + (z.image) ** 2
        numerator = self.multiComplex(z)
        a.real = (numerator.real / denominator)
        a.image = (numerator.image / denominator)
        return a
